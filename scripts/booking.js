...
let selectedDayType = 'full';

const daySelectors = document.querySelectorAll('.day-selector li'); // Select all li elements inside day-selector
...
function updateTotalCost() {
    ...
    calculatedCost = selectedDays * costPerSelectedDay;
